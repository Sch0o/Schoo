...
//
//        //allocate buffer
//        vmaCreateBuffer(Context::GetInstance().vmaAllocator,&createInfo,&vmaAllocationCreateInfo,&buffer1,&allocation,
//                        &vmaAllocationInfo);
//    }
    ...
    std::uint32_t Buffer::QueryBufferMemTypeIndex(std::uint32_t type,vk::MemoryPropertyFlags flags){
        ...
        throw std::runtime_error("dont found fit bufferMemType");
    }
